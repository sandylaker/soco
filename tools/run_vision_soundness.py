...
from soco.metrics import VisionSoundness
from soco.utils import setup_logger


def parse_args():
    parser = ArgumentParser('Run soundness test.')
...
def main():
    ...
    vision_soundness = VisionSoundness(cfg=cfg, device=device)
    vision_soundness.run()
